      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card variant="glass" className="animate-scale-in">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-900 mb-2">Total Income</h3>
          ...
          <Card variant="glass" className="animate-scale-in" style={{ animationDelay: "0.1s" }}>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-900 mb-2">Total Expenses</h3>
              <p className="text-2xl font-bold text-danger-600">{formatCurrency(Math.abs(totalExpenses))}</p>
            </CardContent>
          </Card>
          ...
          <Card variant="glass" className="animate-scale-in" style={{ animationDelay: "0.2s" }}>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-900 mb-2">Net Savings</h3>
        ...
        {showBudgetForm && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
            <Card variant="glass" className="w-full max-w-md mx-4 animate-scale-in">
              ...
              <CardContent className="p-6">
                <form onSubmit={handleBudgetSubmit} className="space-y-6">
                  ...
                  <Input
                    ...
                    onChange={(e) => setBudgetFormData(prev => ({ ...prev, alertThreshold: parseInt(e.target.value) || 80 }))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <CardContent className="p-6">
              {budgets.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">No Budgets Yet</h3>
                  <p className="text-neutral-600 mb-6">Create your first budget to start tracking expenses</p>
                  <Button variant="primary" onClick={() => setShowBudgetForm(true)}>Create Budget</Button>
                </div>
              ) : (
                <div className="space-y-6">
                  {budgets.map((budget) => {
                    const utilization = (budget.amount && budget.amount > 0) ? (Math.abs(budget.spent) / budget.amount) * 100 : 0;
                      ...
                      >
                        ...
                        <div className="flex justify-between text-sm text-neutral-600 mb-3">
                          <span className="font-medium">
                            Spent: <span className="text-neutral-900">{formatCurrency(Math.abs(budget.spent))}</span>
                          </span>
                          <span className="font-medium">
                            Budget: <span className="text-neutral-900">{formatCurrency(budget.amount || 0)}</span>
                          </span>
                        </div>
          ...
          <Card variant="elevated" className="animate-slide-up" style={{ animationDelay: "0.1s" }}>
            <CardHeader className="bg-gradient-to-r from-white to-success-50/30">
              <CardTitle className="text-2xl text-gradient flex items-center">
                <svg className="w-6 h-6 mr-3 text-success-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h2M9 5a2 2 0 012 2v6a2 2 0 01-2 2M9 5a2 2 0 012 2v6a2 2 0 01-2 2m6-6V9a2 2 0 012-2h2a2 2 0 012 2v2M7 19a2 2 0 002-2v-2M15 19a2 2 0 01-2-2v-2" />
                </svg>
                Recent Transactions
              </CardTitle>
            ...
            <CardContent className="p-6">
              {transactions.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-neutral-600 mb-6">Add your first transaction to start tracking</p>
                  <Button variant="success" onClick={() => setShowTransactionForm(true)}>Add Transaction</Button>
                </div>
              ) : (
        ...
        {spendingByCategory.length > 0 && (
          <Card variant="gradient" className="animate-slide-up">
            <CardHeader>
              <CardTitle className="text-2xl text-gradient">Spending by Category</CardTitle>
                  ...
                  >
                    ...
                    <div className="w-full bg-neutral-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(Math.abs(item.amount) / Math.abs(totalExpenses)) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
